...
import chordScales from "./A Crash Course in Chord_Scales.pdf"
    ...
    return (
        <div className="page-wrapper">
            ...
            <div className="blog-post">
                    <h2>A Crash Course in Chord Scales</h2>
                    <p>Click the icon to download / view this post</p>
                    <a id="blog-link" target="_blank" href={chordScales}><i className="fas fa-file-invoice"></i></a>
                </div>
            <div className="blog-post">
